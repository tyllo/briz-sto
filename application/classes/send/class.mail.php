...
class Mail {
    ...
    function Mail($charset="") {
        $this->autoCheck(true);
        $this->boundary = "--" . md5(uniqid("myboundary-tyllo")); //("myboundary
    ...
    function BuildMail() {
        ...
        $this->xheaders["X-Mailer"] = "tyllo php-mail-V 1.8";
    ...
    function smtp_on($smtp_serv, $login, $pass, $port=25, $timeout=20) {
    ...
    function Send() {
        ...
        if (!$this->smtp_on) {
			...
			fputs($smtp_conn, "MAIL FROM: <" . $this->smtp_login . "> SIZE=" . strlen($this->headers . "\r\n" . $this->fullBody) . "\r\n");
    ...
    return true; // возвращаю что все прошло OK
		}
