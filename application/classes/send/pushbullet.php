<?php
include_once('class.pushbullet.php');

function pushbullet($subject="Сообщение с сайта $_SERVER[HTTP_HOST]", $message='Что-то случилось'){
	$API_KEY = 'v162rCWaDqaVAk456qE9EiazWX4dYOVv6pujz6wCQ74Eu';
	
	$message=str_replace('<br />','',$message);
	
	$p = new PushBullet($API_KEY);
	
	$p->pushNote(NULL,  $subject, $message);
